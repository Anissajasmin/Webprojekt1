...
<div id="navbar">
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
                <li class="nav-item active">
                    <a class="nav-link" id="fontfeed" href="hauptseite.php?user_id=<?php echo $my_id; ?>">Mein Feed <span
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                        ...
                        <a class="dropdown-item" id="fonteinstellungen" href="settings.php?user_id=<?php echo $my_id; ?>">Einstellungen</a>
                    </div>

                </li>
                <li class="nav-item active">
                    <a class="nav-link" id="fontfreunde"href="meinefreunde.php?user_id=<?php echo $my_id; ?>">Meine Freunde <span
                                class="sr-only">(current)</span></a>
                </li>
            </ul>
            <div>
        ...
        <form class="form-inline my-2 my-lg-0 ">
            ...
            <button class="btn btn-outline-dark my-2 my-sm-0" style="font-family: 'Helvetica Neue'; font-size:120%; font-weight: 200;" id="suchebutton" type="submit">Suche</button>
        </form>
